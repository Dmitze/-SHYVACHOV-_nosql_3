...
<!-- Відповідь: жанр як окремий вузол — це можливість швидко фільтрувати по конкретному жанру через індекс на g.name. Якщо зберігати жанри масивом у Movie, доводиться сканувати всі Movie та фільтрувати по масиву (O(n)), а ще складно/некоректно будувати ефективні індекси. -->
